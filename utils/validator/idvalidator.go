...
//校验地区码
func IdValidateArea(id string) error {
...
//校验生日,包括格式和范围
func IdValidateBirth(id string) error {
	birth := id[6:14]
...
//校验 校验和
func IdValidateSum(id string) error {
	sum := 0
...
func IsIdCard(id string) bool {
	...
	//if err := IdValidateArea(id); err != nil {
	//	return false
	//}
	if err := IdValidateBirth(id); err != nil {
		return false
	}
	if err := IdValidateSum(id); err != nil {
		return false
	}
	return true
}
